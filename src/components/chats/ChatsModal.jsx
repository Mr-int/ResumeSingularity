    ...
    return (
        <div className="chatsModal__overlay" role="dialog" aria-modal="true" aria-label="Чаты">
            ...
            <div className="chatsModal__panel" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="chatsModal__messenger">
                                    ...
                                    >
                                        ...
                                        <div className="chatsModal__chatDetails">
                                            <div className="chatsModal__chatTitleRow">
                                                ...
                                                <span className="chatsModal__chatTime">
                                                    {formatTime(c.lastActivityAt)}
                                                </span>
                                            </div>
                                            <div className="chatsModal__chatPreviewRow">
                                                <span className="chatsModal__chatPreview">
                        ...
                        <div className="chatsModal__messages">
                            ...
                            {selectedId &&
                                ...
                                messages.map((m, idx) => {
                                    ...
                                    const prevDay =
                                        idx > 0 ? formatDayLabel(messages[idx - 1].createdAt) : null;
